...
class _Settings(_Base):
    ...
    config_debug_tags = Column(String, default="")
...
class ConfigSQL(object):
    ...
    def list_debug_tags(self):
        tags = self.config_debug_tags or ""
        return [strip_whitespaces(t).upper() for t in tags.split(",") if t.strip()]
    ...
    def load(self):
        ...
        self.load_debug_tags()
        self.__dict__["dirty"] = list()

    def load_debug_tags(self):
        logger.set_debug_tags(self.list_debug_tags())
...
def autodetect_calibre_binaries():
    if sys.platform == "win32":
        ...
        calibre_path = ["/opt/calibre/", "/opt/calibre/calibre/"]
