...
class CliParameter(object):
    ...
    def arg_parser(self):
        ...
        parser.add_argument('-a', '--promote-admin', metavar='username',
                            help='Promotes specific username to Full Admin and exits Calibre-Web')
        ...
        # handle and check promote admin argument
        self.promote_admin = args.promote_admin or None
