...
ROLE_VIEWER             = 1 << 8
ROLE_AUDITOR            = 1 << 9  # Library Auditor - write access to book DB
ROLE_LIMITED_ADMIN      = 1 << 10
...
ALL_ROLES = {
                ...
                "limited_admin_role": ROLE_LIMITED_ADMIN,
            }
...
sidebar_settings = {
                ...
                "sidebar_series_tracker": SIDEBAR_SERIES_TRACKER,
                "sidebar_author_dashboard": SIDEBAR_AUTHOR_DASHBOARD,
            }


ADMIN_USER_ROLES        = sum(r for r in ALL_ROLES.values()) & ~ROLE_ANONYMOUS
ADMIN_USER_SIDEBAR      = (SIDEBAR_AUTHOR_DASHBOARD << 1) - 1
...
# User Preference Item Types
ITEM_TYPE_BOOK = 0
ITEM_TYPE_SERIES = 1
ITEM_TYPE_AUTHOR = 2

# User Preference Status
PREFERENCE_STATUS_IGNORED = -1
PREFERENCE_STATUS_PREFERRED = 1
